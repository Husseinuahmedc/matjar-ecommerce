...
const navItems = [
  { href: "/support/orders", labelAr: "طلبات العملاء", labelEn: "Customer Orders", icon: ShoppingCart },
]

export default function SupportSidebar({ locale }: SupportSidebarProps) {
    ...
    <>
      ...
      >
        <div className="flex h-16 items-center justify-between border-b px-6">
          <Link href={`/${locale}/support/orders`} className="text-lg font-bold">
            {isAr ? "دعم العملاء" : "Support"}
          </Link>
          <button
            onClick={() => setOpen(false)}
